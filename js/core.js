...
(function () {
  ...
  const STR = {
    vi: {
      ...
      "workspace.map": "Bản đồ",
      "workspace.city": "Điều hành thành phố",
      "workspace.plant": "Vận hành nhà máy",
      "workspace.backToMap": "Quay lại bản đồ vận hành",
      /* Human labels for the workflow enums. The raw code stays in data-* attributes and
         tooltips (operators quote it in reports); only these strings reach the screen. */
      "status.PROPOSED": "Đã đề xuất",
      "status.SUBMITTED": "Đã trình duyệt",
      "status.APPROVED": "Đã phê duyệt",
      "status.NOTIFIED": "Đã thông báo",
      "status.EXECUTING": "Đang thực thi",
      "status.DEVIATING": "Lệch so với lệnh",
      "status.VERIFIED": "Đã đối chứng",
      "status.CLOSED": "Đã đóng hồ sơ",
      "status.ASSESSED": "Đã đánh giá",
      "status.REJECTED": "Đã từ chối",
      "status.SUPERSEDED": "Đã thay thế",
      "status.NOT_IN_CURRENT_DEMO": "Ngoài phạm vi demo",
      "status.ASSUMED_FOR_DEMO": "Giả định cho demo",
      "status.APPROVED_PLAN": "Phương án đã duyệt",
      "status.PROPOSAL": "Đề xuất",
      "status.RECOMMENDATION": "Khuyến nghị",
      "status.CURRENT_PACKAGE": "Gói hiện hành",
      "status.MISSING": "Chưa có dữ liệu",
      "status.OK": "Đủ dữ liệu",
      "status.MARGIN_CALCULATION_FAILED": "không tính được biên an toàn",
      "status.HydropowerFacility": "Công trình thủy điện",
      "status.operating": "đang phát điện",
      "status.not-generating": "chưa phát điện",
      ...
      "city.lead": "Ai chịu trách nhiệm phê duyệt, hồ nào đang ở bước nào, hạ du chịu ảnh hưởng ra sao — trên cùng một quy trình xả lũ.",
      "city.synthetic": "Dữ liệu mô phỏng · {total} công trình trong sổ đăng ký · {time}",
      "city.scope": "Công trình trong sổ",
      "city.registrySource": "sổ đăng ký Đà Nẵng",
      "city.named": "Đã định danh",
      "city.authoritativeNames": "có tên chính thức",
      "city.unresolved": "Chưa định danh",
      "city.notRowExpanded": "chưa khớp được hồ trong demo",
      "city.portfolio": "Danh mục công trình",
      "city.portfolioLabel": "Danh mục công trình thủy điện trong sổ đăng ký",
      "city.processTimeline": "Tiến độ quy trình",
      "city.processTimelineLabel": "Tiến độ quy trình theo từng công trình",
      ...
      "city.readiness": "Bằng chứng sẵn sàng",
      "city.readinessLabel": "Bằng chứng thông báo và kiểm toán",
      "city.demoMapped": "Có mô phỏng thủy văn trong demo",
      "city.registryOnly": "Chỉ có trong sổ đăng ký",
      "city.plantRoute": "Mở màn hình nhà máy",
      "city.openPlant": "Mở màn hình vận hành nhà máy {name}",
      "city.simPending": "Chưa có số liệu mô phỏng",
      "city.noExecution": "Đang ở bước phối hợp, chưa phát lệnh. Màn hình này không điều khiển cửa van tại nhà máy.",
      "city.noExecutionOrder": "Lệnh {id} · {status}. Màn hình này không điều khiển cửa van tại nhà máy.",
      "city.noPackage": "Chưa có gói quyết định xả đang hoạt động",
      "city.noPackageNote": "Chưa gán được người chịu trách nhiệm khi chưa có gói đề xuất.",
      "city.accountableRole": "Vai trò chịu trách nhiệm: {role}",
      "city.consulted": "Tham vấn: {roles}",
      "city.consultedNone": "Chưa ghi nhận đơn vị tham vấn",
      "city.approvalEvidence": "Bằng chứng phê duyệt được lưu trong nhật ký kiểm toán.",
      "city.orderRef": "Lệnh {id} · sự kiện {event} · công trình {facility}",
      "city.queueMeta": "{proposals} đề xuất · {orders} lệnh đã phê duyệt cho sự kiện đang xét",
      "city.unresolvedText": "{count} công trình chưa khớp được với hồ nào trong bản demo",
      "city.alertTrend": "Báo động {alert} · xu thế {trend} m/3h",
      "city.simUnavailable": "Chưa có số liệu mô phỏng",
      "city.simProvenance": "Nguồn: mô hình thủy văn của bản demo, dữ liệu tổng hợp — không phải số đo quan trắc thời gian thực.",
      "city.auditEntries": "Mục kiểm toán",
      "city.auditNote": "nhật ký chỉ ghi thêm, lưu tại máy",
      "city.notificationEvidence": "Bằng chứng thông báo",
      "city.notificationNote": "đã ghi, không suy đoán là đã gửi",
      "city.workflowEvidence": "Bằng chứng quy trình",
      "city.workflowNote": "vết quyết định và lệnh xả",
      "city.noRefusal": "Chưa có phê duyệt nào bị từ chối trong sự kiện này.",
      "city.refusal": "Lần từ chối gần nhất: {actor} không đủ thẩm quyền {role}, nên không tạo được lệnh.",
      "city.readinessProvenance": "Nguồn: nhật ký kiểm toán của phiên trình duyệt này. Số 0 nghĩa là chưa ghi được bằng chứng nào, không phải mất dữ liệu.",
      "city.unknownRole": "vai trò không xác định",
      "city.requiredRole": "vai trò bắt buộc",
      "city.unassignedRaci": "chưa phân công",
      "plant.eyebrow": "Vận hành nhà máy",
      "plant.unknownFacility": "Công trình không xác định",
      "plant.lead": "Trạng thái hồ, khuyến nghị xả, ranh giới phê duyệt và mức sẵn sàng thực thi của công trình đang chọn.",
      "plant.synthetic": "Dữ liệu mô phỏng · mọi giá trị đều ghi rõ nguồn · {time}",
      "plant.noRegistry": "Không có bản ghi trong sổ đăng ký",
      "plant.facility": "Công trình",
      "plant.facilityAria": "Công trình nhà máy",
      "plant.registrySource": "Sổ đăng ký {source} · số liệu ngày {date} · {state}",
      "plant.registryMissing": "Công trình đang chọn không có trong sổ đăng ký.",
      "plant.currentState": "Trạng thái hiện tại",
      "plant.currentStateLabel": "Trạng thái nhà máy hiện tại",
      "plant.noPlantData": "{name} có trong sổ đăng ký ({type}), nhưng bản demo này chưa nạp dữ liệu vận hành của nhà máy.",
      "plant.selectedUnavailable": "Công trình đang chọn không có trong sổ đăng ký.",
      "plant.inspectionSource": "Kiểm tra: {status} · nguồn {source} · ngày {date}",
      "plant.noSource": "Chưa có bản ghi nguồn cho công trình này.",
      "plant.reservoirLevel": "Mực hồ",
      "plant.inflow": "Dòng vào",
      "plant.currentRelease": "Lưu lượng xả hiện tại",
      "plant.freeboard": "Độ vượt cao an toàn",
      "plant.syntheticReservoir": "mô phỏng, không phải số đo",
      "plant.simNotTelemetry": "mô phỏng, không phải số đo",
      "plant.simActivePolicy": "mô phỏng theo quy tắc đang chọn",
      "plant.assumedDesign": "theo thông số thiết kế giả định",
      "plant.marginUnavailable": "chưa tính được biên an toàn",
      "plant.marginFailed": "Không tính được biên an toàn cho {name}. Màn hình không thay bằng giá trị ước lượng.",
      "plant.stateProvenance": "Nguồn: mô hình hồ chứa của bản demo, số liệu nền ngày {date}. Mọi giá trị là mô phỏng hoặc giả định, không phải quan trắc.",
      "plant.actionable": "có thể chuyển thành đề xuất",
      "plant.notActionable": "chưa thể chuyển thành đề xuất",
      "plant.orderRef": "Lệnh {id} · sự kiện {event} · đề xuất {proposal} · quyết định {decision}",
      "plant.advisory": "Khuyến nghị xả",
      "plant.advisoryLabel": "Khuyến nghị xả cho công trình đang chọn",
      "plant.noAdvisory": "Công trình này nằm ngoài phạm vi bản demo, nên không tính khuyến nghị xả, chỉ dẫn cửa van hay hướng dẫn vận hành.",
      "plant.lifecycle": "Bước hiện tại: {class} · {actionable}",
      "plant.notTargeted": "Gói đề xuất hiện hành không nhắm tới {name}, nên màn hình không hiển thị khuyến nghị xả hay chỉ dẫn cửa van cho công trình này.",
      ...
      "plant.proposeReason": "Bản demo chỉ trình bày khuyến nghị; luồng tạo đề xuất chưa mở ở màn hình này.",
      "plant.approveReason": "Chỉ người có định danh và đúng thẩm quyền mới tạo được lệnh.",
      "plant.executeReason": "Chưa có lệnh đã phê duyệt nào đang hiệu lực.",
      "plant.noActionable": "Không có khuyến nghị có thể hành động.",
      "plant.noProposal": "Không có gói đề xuất tại thời điểm hiện tại.",
      "plant.noProposalClass": "Tại thời điểm này chưa có gói ở dạng đề xuất.",
      "plant.proposedRelease": "Lưu lượng xả đề xuất",
      "plant.start": "Bắt đầu",
      "plant.requiresApproval": "cần phê duyệt",
      "plant.controlPoint": "Điểm kiểm soát",
      "plant.downstreamSimulation": "theo mô phỏng hạ du",
      "plant.peakCut": "Giảm đỉnh",
      "plant.modelledComparison": "so với phương án quy tắc",
      "plant.gateAssumption": "Giả định cho demo — ghi chú cửa van của {name}: {gates}. Hình học từng cửa van chưa được mô hình hóa, nên không có độ mở đã xác minh.",
      "plant.advisorySource": "Nguồn: gói quyết định hiện hành của bản demo. Đề xuất ghi nhận cho công trình này: {proposal}.",
      "plant.advisoryHiddenSource": "Nguồn: sổ đăng ký và trạng thái thủy văn của {name}. Khuyến nghị chỉ hiện khi công trình là mục tiêu của gói đề xuất.",
      "plant.alternatives": "Phương án thay thế",
      "plant.noNumericNotDemo": "Không tính phương án số cho công trình ngoài phạm vi demo.",
      "plant.noNumericNotTarget": "Không hiển thị phương án số cho {name} vì gói đề xuất hiện hành không nhắm tới công trình này.",
      ...
      "plant.noApprovedOrder": "Chưa có lệnh vận hành nào đang hiệu lực cho công trình này.",
      "plant.recommendationBoundary": "Khuyến nghị tách biệt với lệnh. Màn hình này không tạo lệnh vận hành.",
      "plant.approvedOrderId": "Mã lệnh",
      "plant.package": "Gói",
      ...
      "plant.checklistLocked": "Danh sách kiểm tra mở khi có lệnh đã phê duyệt.",
      "plant.execution": "Thực thi",
      "plant.executionLabel": "Trạng thái thực thi",
      "plant.noExecutionState": "Chưa có trạng thái thực thi. Các nút thực thi mở sau khi lệnh được phê duyệt.",
      "plant.order": "Lệnh",
      "plant.commandedRelease": "Lưu lượng xả đã lệnh",
      "plant.observedRelease": "Lưu lượng xả thực tế",
      "plant.deviation": "Sai lệch",
      "plant.notStarted": "chưa bắt đầu",
      "plant.approvedCommand": "lệnh đã phê duyệt",
      "plant.telemetryMissing": "chưa có số đo",
      "plant.tolerance": "Dung sai giữa thực tế và lệnh: {value} m³/s — giả định cho demo, không phải ngưỡng pháp quy.",
      "plant.startExecution": "Bắt đầu thực thi",
      "plant.startReason": "Cần đủ bốn điều kiện: lệnh hợp lệ, đã xác nhận thông báo, kíp nhà máy sẵn sàng và tuyến xả sẵn sàng.",
      "plant.recordActual": "Ghi thực tế mô phỏng",
      "plant.recordReason": "Ghi lưu lượng xả của công trình đang chọn, lấy từ mô hình mô phỏng.",
      "plant.closeComplete": "Đóng hoàn tất",
      "plant.closeReason": "Cần có số liệu thực thi và các mục kiểm tra đã hoàn tất.",
      "plant.missingDependencies": "Dữ liệu vận hành còn thiếu",
      "plant.identityMeta": "Mã {id} · {type} · {status}",
      ...
      "plant.recommendationOnly": "mới là khuyến nghị, chưa phải lệnh",
      "plant.revision": "phiên bản {revision}",
      "plant.assumedCommand": "giá trị giả định cho demo, lấy từ gói đã phê duyệt",
      "plant.storedApproval": "bằng chứng phê duyệt đã lưu",
      "plant.noneStored": "chưa lưu",
      "plant.dep.telemetry": "bản demo này chưa được cấp nguồn số đo thời gian thực",
      "plant.dep.storage": "bản demo này chưa được cấp dung tích hồ và hình học cửa xả",
    ...
    en: {
      ...
      "workspace.backToMap": "Back to the operational map",
      "status.PROPOSED": "Proposed",
      "status.SUBMITTED": "Submitted",
      "status.APPROVED": "Approved",
      "status.NOTIFIED": "Notified",
      "status.EXECUTING": "Executing",
      "status.DEVIATING": "Deviating from order",
      "status.VERIFIED": "Verified",
      "status.CLOSED": "Closed",
      "status.ASSESSED": "Assessed",
      "status.REJECTED": "Rejected",
      "status.SUPERSEDED": "Superseded",
      "status.NOT_IN_CURRENT_DEMO": "Outside demo scope",
      "status.ASSUMED_FOR_DEMO": "Assumed for demo",
      "status.APPROVED_PLAN": "Approved plan",
      "status.PROPOSAL": "Proposal",
      "status.RECOMMENDATION": "Recommendation",
      "status.CURRENT_PACKAGE": "Current package",
      "status.MISSING": "No data",
      "status.OK": "Data available",
      "status.MARGIN_CALCULATION_FAILED": "safety margin could not be calculated",
      "status.HydropowerFacility": "Hydropower facility",
      "status.operating": "in operation",
      "status.not-generating": "not generating",
      ...
      "city.lead": "Who signs off, which reservoir is at which step, and what the downstream effect is — on one shared release workflow.",
      "city.synthetic": "Simulated data · {total} facilities in the registry · {time}",
      ...
      "city.unresolved": "Not yet identified",
      "city.notRowExpanded": "no matching reservoir in the demo",
      ...
      "city.readiness": "Readiness evidence",
      "city.readinessLabel": "Notification and audit readiness",
      "city.demoMapped": "Has a hydrological simulation in the demo",
      "city.registryOnly": "In the registry only",
      "city.plantRoute": "Open plant screen",
      "city.openPlant": "Open plant workspace for {name}",
      "city.simPending": "No simulation data yet",
      "city.noExecution": "At the coordination step, no order issued. This screen does not operate gates at the plant.",
      "city.noExecutionOrder": "Order {id} · {status}. This screen does not operate gates at the plant.",
      ...
      "city.orderRef": "Order {id} · event {event} · facility {facility}",
      "city.queueMeta": "{proposals} proposals · {orders} approved orders in shared release workflow snapshot",
      "city.unresolvedText": "{count} facilities with no matching reservoir in the demo",
      "city.alertTrend": "Alert {alert} · trend {trend} m/3h",
      "city.simUnavailable": "No simulation data",
      "city.simProvenance": "Source: the demo hydrological model, synthetic data — not real-time observations.",
      ...
      "city.noRefusal": "No approval has been refused in this event.",
      "city.refusal": "Most recent refusal: {actor} did not hold {role} authority, so no order could be created.",
      "city.readinessProvenance": "Source: this browser session's audit log. Zero means nothing has been recorded yet, not that data was lost.",
      ...
      "plant.registrySource": "Registry {source} · data dated {date} · {state}",
      ...
      "plant.noPlantData": "{name} is in the registry ({type}), but this demo carries no operational plant data for it.",
      "plant.selectedUnavailable": "Selected facility is not available in the governed registry.",
      "plant.inspectionSource": "Inspection: {status} · source {source} · date {date}",
      ...
      "plant.simNotTelemetry": "simulated, not measured",
      ...
      "plant.marginFailed": "Safety margin could not be calculated for {name}. The screen does not substitute an estimate.",
      "plant.stateProvenance": "Source: the demo reservoir model, baseline data dated {date}. Every value is simulated or assumed, not observed.",
      "plant.actionable": "can become a proposal",
      "plant.notActionable": "cannot become a proposal yet",
      "plant.orderRef": "Order {id} · event {event} · proposal {proposal} · decision {decision}",
      "plant.advisory": "Advisory recommendation",
      "plant.advisoryLabel": "Advisory recommendation",
      "plant.noAdvisory": "This facility is outside the demo scope, so no release recommendation, gate instruction or operational guidance is computed.",
      "plant.lifecycle": "Current step: {class} · {actionable}",
      "plant.notTargeted": "The current proposal package does not target {name}, so no release recommendation or gate instruction is shown for this facility.",
      ...
      "plant.proposeReason": "This demo presents recommendations only; the proposal flow is not open on this screen.",
      "plant.approveReason": "Only an attributed entitled approval can create an approved order.",
      "plant.executeReason": "No approved order is currently in force.",
      ...
      "plant.gateAssumption": "Assumed for the demo — gate note for {name}: {gates}. Individual gate geometry is not modelled, so no verified openings are available.",
      "plant.advisorySource": "Source: the demo's current decision package. Proposal recorded for this facility: {proposal}.",
      "plant.advisoryHiddenSource": "Source: the registry and hydrological state of {name}. Recommendations appear only when the facility is the target of a proposal package.",
      "plant.alternatives": "Alternatives",
      "plant.noNumericNotDemo": "No numeric alternatives are computed for facilities outside the demo scope.",
      "plant.noNumericNotTarget": "No numeric alternatives are shown for {name} because the current proposal package does not target it.",
      ...
      "plant.recommendationBoundary": "Recommendations stay separate from orders. This screen does not create operational orders.",
      "plant.approvedOrderId": "Order ID",
      ...
      "plant.checklistLocked": "The checklist opens once an approved order exists.",
      "plant.execution": "Execution",
      "plant.executionLabel": "Execution status",
      "plant.noExecutionState": "No execution state yet. Execution controls open once the order is approved.",
      "plant.order": "Order",
      ...
      "plant.telemetryMissing": "not measured yet",
      "plant.tolerance": "Tolerance between actual and commanded release: {value} m³/s — a demo assumption, not a regulatory threshold.",
      "plant.startExecution": "Start execution",
      "plant.startReason": "Requires all four: a valid order, acknowledged notifications, plant crew ready and outlet ready.",
      "plant.recordActual": "Record simulated actual",
      "plant.recordReason": "Records the selected facility's release, taken from the simulation model.",
      ...
      "plant.identityMeta": "Ref {id} · {type} · {status}",
      ...
      "plant.recommendationOnly": "a recommendation, not an order",
      "plant.revision": "revision {revision}",
      "plant.assumedCommand": "assumed for the demo, taken from the approved package",
      "plant.storedApproval": "stored approval evidence",
      "plant.noneStored": "none stored",
      "plant.dep.telemetry": "no real-time measurement feed is supplied to this demo",
      "plant.dep.storage": "reservoir storage and outlet geometry are not supplied to this demo",
  ...
  FT.i18n = {
    ...
    /* Workflow enums are machine codes (NOT_IN_CURRENT_DEMO, ASSUMED_FOR_DEMO, …). They are
       fine in data attributes and audit records but must never be the words a user reads, so
       every screen goes through here. Unknown codes degrade to a readable phrase rather than
       leaking SHOUTING_SNAKE_CASE. */
    status(code) {
      const raw = String(code == null ? "" : code).trim();
      if (!raw) return "—";
      const key = `status.${raw}`;
      const hit = FT.i18n.t(key);
      if (hit !== key) return hit;
      const words = raw.replace(/_/g, " ").toLowerCase();
      return words.charAt(0).toUpperCase() + words.slice(1);
    },
    /* Number locale follows the interface language: a Vietnamese screen showing "1,530"
       reads as one-point-five, not fifteen hundred. */
    locale() { return FT.state.lang === "en" ? "en-US" : "vi-VN"; },
    num(value, digits) {
      if (!Number.isFinite(value)) return "—";
      return value.toLocaleString(FT.i18n.locale(), { maximumFractionDigits: digits == null ? 1 : digits });
    },
    apply(root) {
