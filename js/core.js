...
(function () {
  ...
  const STR = {
    vi: {
      ...
      "foot.mode": "Dữ liệu tổng hợp minh hoạ phương pháp — không dùng cho vận hành thật",
    ...
    en: {
      ...
      "foot.mode": "Synthetic demo data illustrating the method — not for real operations",
